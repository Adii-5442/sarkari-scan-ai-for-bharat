      ...
      {categories.map((cat) => {
        ...
        return (
          <Link
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-full border transition-all shrink-0 hover:scale-105 hover:shadow-md"
            style={{
              backgroundColor: isSelected ? cat.color : "white",
              borderColor: isSelected ? cat.color : "#E5E7EB",
              boxShadow: isSelected ? `0 4px 12px ${cat.color}30` : undefined,
            }}
