...
export const metadata: Metadata = {
  title: `Sarkari Naukri ${currentYear} | Sarkari Naukri | Sarkari Scan`,
  description: `Latest sarkari naukri notifications, government job vacancies ${currentYear}. Find latest vacancies, eligibility, salary, and apply online. Updated daily.`,
  alternates: { canonical: `https://sarkariscan.com/sarkari-naukri` },
  openGraph: {
    title: `Sarkari Naukri ${currentYear} – Sarkari Scan`,
    description: `Latest sarkari naukri notifications, government job vacancies. Latest notifications ${currentYear}.`,
    url: `https://sarkariscan.com/sarkari-naukri`, type: "website",
  },
};
    ...
    <div className="min-h-screen">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: generateBreadcrumbJsonLd([
            { name: "Home", href: "/" },
            { name: `Sarkari Naukri ${currentYear}`, href: "/sarkari-naukri" },
          ]),
        }}
      />
      <section className="hero-glass py-8 md:py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 animate-fade-in-up" style={{ color: "#FFFFFF" }}>
            📰 <span style={{ color: "#FFD700" }}>Sarkari Naukri</span> {currentYear}
          </h1>
          <p className="text-sm md:text-base max-w-xl mx-auto mb-6 animate-fade-in-up" style={{ color: "rgba(255,255,255,0.9)" }}>
            Latest sarkari naukri notifications, government job vacancies
          </p>
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-gray-500" aria-label="Breadcrumb">
        <ol className="flex items-center gap-1.5">
          ...
          <li className="before:content-['/'] before:mx-1.5 before:text-gray-300 text-gray-700 font-medium">Sarkari Naukri</li>
        </ol>
      </nav>

      <section className="py-8 bg-[#F7FAFC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl font-bold text-gray-900 mb-1">Latest Sarkari Naukri Notifications {currentYear}</h2>
