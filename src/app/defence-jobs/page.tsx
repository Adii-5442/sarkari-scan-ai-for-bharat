...
export const metadata: Metadata = {
  title: `Defence Jobs ${currentYear} | Sarkari Naukri | Sarkari Scan`,
  description: `Indian Army, Navy, Air Force, BSF, CRPF, CISF, Coast Guard recruitment ${currentYear}. Find latest vacancies, eligibility, salary, and apply online. Updated daily.`,
  alternates: { canonical: `https://sarkariscan.com/defence-jobs` },
  openGraph: {
    title: `Defence Jobs ${currentYear} – Sarkari Scan`,
    description: `Indian Army, Navy, Air Force, BSF, CRPF, CISF, Coast Guard recruitment. Latest notifications ${currentYear}.`,
    url: `https://sarkariscan.com/defence-jobs`, type: "website",
  },
};
    ...
    <div className="min-h-screen">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: generateBreadcrumbJsonLd([
            { name: "Home", href: "/" },
            { name: `Defence Jobs ${currentYear}`, href: "/defence-jobs" },
          ]),
        }}
      />
      <section className="hero-glass py-8 md:py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 animate-fade-in-up" style={{ color: "#FFFFFF" }}>
            🛡️ <span style={{ color: "#FFD700" }}>Defence Jobs</span> {currentYear}
          </h1>
          <p className="text-sm md:text-base max-w-xl mx-auto mb-6 animate-fade-in-up" style={{ color: "rgba(255,255,255,0.9)" }}>
            Indian Army, Navy, Air Force, BSF, CRPF, CISF, Coast Guard recruitment
          </p>
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-gray-500" aria-label="Breadcrumb">
        <ol className="flex items-center gap-1.5">
          ...
          <li className="before:content-['/'] before:mx-1.5 before:text-gray-300 text-gray-700 font-medium">Defence Jobs</li>
        </ol>
      </nav>

      <section className="py-8 bg-[#F7FAFC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl font-bold text-gray-900 mb-1">Latest Defence Jobs Notifications {currentYear}</h2>
