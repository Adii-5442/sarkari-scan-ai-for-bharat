...
export const metadata: Metadata = {
  title: `Railway Jobs ${currentYear} | Sarkari Naukri | Sarkari Scan`,
  description: `RRB NTPC, Group D, ALP, JE, RPF, Railway vacancies ${currentYear}. Find latest vacancies, eligibility, salary, and apply online. Updated daily.`,
  alternates: { canonical: `https://sarkariscan.com/railway-jobs` },
  openGraph: {
    title: `Railway Jobs ${currentYear} – Sarkari Scan`,
    description: `RRB NTPC, Group D, ALP, JE, RPF, Railway vacancies. Latest notifications ${currentYear}.`,
    url: `https://sarkariscan.com/railway-jobs`, type: "website",
  },
};
    ...
    <div className="min-h-screen">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: generateBreadcrumbJsonLd([
            { name: "Home", href: "/" },
            { name: `Railway Jobs ${currentYear}`, href: "/railway-jobs" },
          ]),
        }}
      />
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-gray-500" aria-label="Breadcrumb">
        <ol className="flex items-center gap-1.5">
          ...
          <li className="before:content-['/'] before:mx-1.5 before:text-gray-300 text-gray-700 font-medium">Railway Jobs</li>
        </ol>
      </nav>

      <section className="py-8 bg-[#F7FAFC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl font-bold text-gray-900 mb-1">Latest Railway Jobs Notifications {currentYear}</h2>
